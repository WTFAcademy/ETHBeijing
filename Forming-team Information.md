...
# 9. Web3Club
* 简介：基于Ethereum 的Web3 互动性百科
* 目标：我们会在赛程期间 为该项目 尝试做一个demo 之后希望能让更多参与活动的朋友 了解以及为我们的项目 提供建议 
* 是否招募队员：接受 暂无任何要求
...
* 目标：1.第一版本DeshopDao平台的上线 2.DeshopDao 的组建和治理框架和工具的上线
* 是否招募队员：接受参赛同学加入，合约端，后端，前端都可以。
* 如何联系：WeChat ID: 18610773817
# 11. 0xtomb
* 简介：区块链坟墓，链上都有结婚证了，时候考虑在链上死亡的问题了
* 目标：联通合约和网站，完善发展规划
* 是否招募队员：需要，产品经理/设计师
* 如何联系：WeChat ID: hardman
# 12. Prestare
